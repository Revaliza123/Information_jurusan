...
--
-- Host: 127.0.0.1
-- Generation Time: May 12, 2023 at 04:13 AM
...
--
-- Stand-in structure for view `vdata1`
-- (See below for the actual view)
--
CREATE TABLE `vdata1` (
`nisn` varchar(11)
...
--
-- Stand-in structure for view `vdata2`
-- (See below for the actual view)
--
CREATE TABLE `vdata2` (
`nisn` varchar(11)
...
--
-- Stand-in structure for view `vdata3`
-- (See below for the actual view)
--
CREATE TABLE `vdata3` (
`nisn` varchar(10)
...
--
-- Stand-in structure for view `vdata4`
-- (See below for the actual view)
--
CREATE TABLE `vdata4` (
`nisn` varchar(10)
...
--
-- Stand-in structure for view `vdata5`
-- (See below for the actual view)
--
CREATE TABLE `vdata5` (
`nisn` varchar(10)
...
--
-- Stand-in structure for view `vdata6`
-- (See below for the actual view)
--
CREATE TABLE `vdata6` (
`nisn` varchar(10)
