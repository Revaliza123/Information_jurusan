...
.dropdown:hover .dropdown-content {
  display: block;
    ...
    <button style="display:block;background: #87A96B;;margin-top:300px;margin-left:1230px;margin-bottom:opx;"><a href="datasiswa12.php">REGULER</a></button>
</head>
<body>
