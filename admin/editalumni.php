...
<div class="mb-3">
    ...
    <input class="form-control" id="exampleInputnisn" aria-describedby="namaHelp" type="text" name="id" value="<?php echo $data['id'];?>"></input>
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    <label for="exampleInputkelas" class="form-label">PERIODE</label>
    <input  class="form-control" id="exampleInputkelas" aria-describedby="namaHelp" type="text" name="periode" value="<?php echo $data['periode'];?>"></input>
  </div>
  <div class="mb-3">
...
if(isset($_POST['proses'])){
    ...
    echo "<meta http-equiv=refresh content=1;URL='alumniadmin.php'>";
}
?>
</body>
</html>