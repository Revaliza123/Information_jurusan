...
<body>
  ...
  <div class="mb-3">
    <label for="exampleInputnisn" class="form-label">ID</label>
    <input type="nisn" class="form-control" id="exampleInputnisn" aria-describedby="namaHelp" name="id">
  </div>
  <div class="mb-3">
  ...
  <div class="mb-3">
    <label for="exampleInputid_kelas" class="form-label">Periode</label>
    <input type="kelas" class="form-control" id="exampleInputid_kelas" aria-describedby="namaHelp" name="periode">
  </div>
  <div class="mb-3">
