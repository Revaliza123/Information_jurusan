...
.dropdown:hover .dropdown-content {
  display: block;
    ...
    <button style="display:block;background: #87A96B;;margin-top:300px;margin-left:1230px;margin-bottom:opx;"><a href="datasiswaadminor12.php">INDUSTRI</a></button>
</head>
<body>
    <h2>SISWA XII RPL</h2>

<table border="2" style="margin-top:130px;margin-left:150px;">
<tr align="center">              
...
?>
    ...
    while ($tampil = mysqli_fetch_array($ambil)){
        ...
        <tr>
            ...
            <td><a style=color:black;font-size:20px; href='editsiswa12.php?kode=$tampil[nisn]'>Edit</a></td>
        </tr>";  
        }
    ?>
        ...
        <button style=display:block;margin-top:90px;margin-left:660px;><a style="color:black;" href="inputsiswa12.php">Tambah Data</a></button>
            ...
            if(isset($_GET['kode'])){
                ...
                echo "<meta http-equiv=refresh content=2;URL='datasiswaadmin12.php'>";
            }
            ?>
</body>
</html>